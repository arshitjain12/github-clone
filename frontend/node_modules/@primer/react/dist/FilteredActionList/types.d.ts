...
export type ItemInput = Merge<React.ComponentPropsWithoutRef<'div'>, FilteredActionListItemProps> | ((Partial<FilteredActionListItemProps> & {
...
export interface GroupedListProps extends ListPropsBase {
     ...
     */
    groupMetadata: ((Omit<ActionListGroupProps, 'items'> | Omit<Partial<ActionListGroupProps> & {
        renderItem?: RenderItemFn;
     ...
     */
    items: ((FilteredActionListItemProps | (Partial<FilteredActionListItemProps> & {
        renderItem: RenderItemFn;
    })) & {
        groupId: string;
    })[];
